	...
	<FORM METHOD="post" ACTION="order.do" name="form1">
		<table>
			...
			<tr>
				...
				<td><input type="hidden" name="od_create_date"
					value="<%= orderVO.getOdCreateDate() %>" size="45" /></td>
			</tr>

			<tr>
				<td>購買人：</td>
				<td><input type="TEXT" name="u_id"
					value="<%=orderVO.getUser().getuId() %>" size="45" /></td>
			</tr>
			<tr>
				<td>交易完成時間：</td>
				<td><%= orderVO.getOdEndDate() %></td>
				<td>
				<input type="hidden" name="od_end_date"
					value="<%= orderVO.getOdEndDate() %>" size="45" /></td>
			</tr>

			<tr>
				<td>交易狀態：</td>
				<td><input type="TEXT" name="od_status"
					value="<%=orderVO.getOdStatus()%>" size="45" /></td>
			</tr>

			<tr>
				<td>訂單總金額：</td>
				<td><input type="TEXT" name="od_price"
					value="<%=orderVO.getOdPrice()%>" size="45" /></td>
			</tr>

			<tr>
				<td>優惠活動ID：</td>
				<td><input type="TEXT" name="dc_id"
					value="<%=orderVO.getDc().getDcId()%>" size="45" /></td>
			</tr>

		</table>
		<br> 
		<input type="hidden" name="action" value="update"> 
		<input type="hidden" name="od_id" value="<%=orderVO.getOdId()%>"> 
...
<%--  		   value: '<%=OrderVO.getOdCreateDate()%>', // value:   new Date(), --%>
