<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
	...
	<%-- 若會員是剛註冊跳轉過來是會判斷session有沒有註冊成功存入的資訊 若有則跳出通知 --%>
		<% if (session.getAttribute("registrationSuccess") !=null && (boolean)
			session.getAttribute("registrationSuccess")) { %>
			<div class="registration-success-notification">註冊成功，請登入。</div>
									...
									<div class="mainbar-row rbt-navigation-start align-items-center">
										...
										<div class="rbt-main-navigation d-none d-xl-block">
											<nav class="mainmenu-nav">
												<ul class="mainmenu">
													<li
														class="with-megamenu has-menu-child-item position-static mainmenu-sub">
                                        ...
                                        <a href="#">Elements <i class="feather-chevron-down"></i></a>
													...
													<li><a href=""><img src=".//THA105G2/assets/images/bell.png"
																alt=""></a></li>
													<li><a href="./g2-cart.html"><img
																src=".//THA105G2/assets/images/cart.png" alt=""></a>
													</li>
													<li><a href=""><img src=".//THA105G2/assets/images/mail.png"
																alt=""></a></li>
													<li
														class="with-megamenu has-menu-child-item position-static mainmenu-sub">
							...
							<div class="inner-wrapper">
								<div class="inner-top">
									...
									<ul class="navbar-top-left rbt-information-list justify-content-start">
										<li><a href="mailto:hello@example.com"><i
													class="feather-mail"></i>example@gmail.com</a></li>
								...
								<nav class="side-nav w-100">
									<ul class="rbt-minicart-wrapper">
										<li class="minicart-item">
											<div class="thumbnail">
												<a href="#"> <img src="/THA105G2/assets/images/product/1.jpg"
														alt="Product Images">
												</a>
											</div>
										...
										<li class="minicart-item">
											<div class="thumbnail">
												<a href="#"> <img src="/THA105G2/assets/images/product/7.jpg"
														alt="Product Images">
												</a>
											</div>
											<div class="product-content">
										...
										<li class="minicart-item">
											<div class="thumbnail">
												<a href="#"> <img src="/THA105G2/assets/images/product/3.jpg"
														alt="Product Images">
												</a>
											</div>
											<div class="product-content">
										...
										<li class="minicart-item">
											<div class="thumbnail">
												<a href="#"> <img src="/THA105G2/assets/images/product/4.jpg"
														alt="Product Images">
												</a>
											</div>
											<div class="product-content">
											...
											<form class="max-width-auto" method="post"
												...
												<div class="form-submit-group">
													<button type="submit"
														...
														<span class="icon-reverse-wrapper"> <span
																class="btn-text">登入</span> <span class="btn-icon"><i
